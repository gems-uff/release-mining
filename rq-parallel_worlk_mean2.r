...
merges_mean <- 100 * sum(releases$merges)/sum(releases$commits)
...
wilcox.test(releases_bproj$time_precision.few, releases_bproj$time_precision.many, paired = TRUE)
cliff.delta(releases_bproj$time_precision.few, releases_bproj$time_precision.many)

wilcox.test(releases_bproj$time_recall.few, releases_bproj$time_recall.many, paired = TRUE)
cliff.delta(releases_bproj$time_recall.few, releases_bproj$time_recall.many)

wilcox.test(releases_bproj$range_precision.few, releases_bproj$range_precision.many, paired = TRUE)
#cliff.delta(releases_bproj$range_precision.few, releases_bproj$range_precision.many)

wilcox.test(releases_bproj$range_recall.few, releases_bproj$range_recall.many, paired = TRUE)
