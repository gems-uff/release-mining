...
data = [analyze_project(project.Index, project.lang, suffix_exception_catalog, release_exception_catalog) for project in projects.itertuples()]
#data = [analyze_project("briannesbitt/Carbon", "java", suffix_exception_catalog, release_exception_catalog)]
releases = pd.concat(data)
